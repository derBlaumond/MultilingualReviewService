...
const (
	ReviewService_GetReviews_FullMethodName   = "/hipstershop.ReviewService/GetReviews"
	ReviewService_SubmitReview_FullMethodName = "/hipstershop.ReviewService/SubmitReview"
)
