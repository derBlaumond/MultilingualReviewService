...
class ReviewServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetReviews = channel.unary_unary(
                '/hipstershop.ReviewService/GetReviews',
                request_serializer=demo__pb2.GetReviewsRequest.SerializeToString,
                response_deserializer=demo__pb2.GetReviewsResponse.FromString,
                )
        self.SubmitReview = channel.unary_unary(
                '/hipstershop.ReviewService/SubmitReview',
                request_serializer=demo__pb2.SubmitReviewRequest.SerializeToString,
                response_deserializer=demo__pb2.SubmitReviewResponse.FromString,
                )
...
def add_ReviewServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetReviews': grpc.unary_unary_rpc_method_handler(
                    servicer.GetReviews,
                    request_deserializer=demo__pb2.GetReviewsRequest.FromString,
                    response_serializer=demo__pb2.GetReviewsResponse.SerializeToString,
            ),
            'SubmitReview': grpc.unary_unary_rpc_method_handler(
                    servicer.SubmitReview,
                    request_deserializer=demo__pb2.SubmitReviewRequest.FromString,
                    response_serializer=demo__pb2.SubmitReviewResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.ReviewService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ReviewService(object):
    ...
    def GetReviews(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.ReviewService/GetReviews',
            demo__pb2.GetReviewsRequest.SerializeToString,
            demo__pb2.GetReviewsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SubmitReview(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.ReviewService/SubmitReview',
            demo__pb2.SubmitReviewRequest.SerializeToString,
            demo__pb2.SubmitReviewResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
