...
class ReviewServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SubmitReview = channel.unary_unary(
                ...
                response_deserializer=demo__pb2.AddReviewResponse.FromString,
                _registered_method=True)
...
def add_ReviewServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SubmitReview': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=demo__pb2.AddReviewResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.ReviewService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hipstershop.ReviewService', rpc_method_handlers)
...
class ReviewService(object):
    ...
    def SubmitReview(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            demo__pb2.AddReviewResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
